...
// ISO 4217 active currency codes with display symbols.
// Sorted alphabetically by code. Used by the full-list searchable picker.
export const CURRENCIES: readonly Currency[] = [
  ...
  { code: 'GYD', symbol: 'GY$', name: 'Guyanaese Dollar' },
...
// Popular currencies shown as the default horizontal chip strip on the
// expense entry screen. Full list available via the "More…" modal.
export const POPULAR_CURRENCIES: readonly string[] = [
  'USD', 'EUR', 'GBP', 'ILS', 'JPY',
  'CHF', 'CAD', 'AUD', 'CNY', 'INR',
  'MXN', 'BRL', 'THB', 'TRY', 'KRW',
  'SGD', 'HKD', 'NZD', 'SEK', 'NOK',
...
// Used by the add-expense screen to auto-pick a currency from the captured
// location's reverse-geocoded country. Multi-country currencies (EUR, XOF,
// XAF, XPF, XCD) all map their member countries back to the shared code.
export const COUNTRY_TO_CURRENCY: Readonly<Record<string, string>> = {
  AE: 'AED', AF: 'AFN', AL: 'ALL', AM: 'AMD', AO: 'AOA', AR: 'ARS',
  AS: 'USD', AU: 'AUD', AW: 'AWG', AZ: 'AZN', BA: 'BAM', BB: 'BBD',
  ...
  CA: 'CAD', CD: 'CDF', CF: 'XAF', CG: 'XAF', CH: 'CHF', CI: 'XOF',
  CK: 'NZD', CL: 'CLP', CM: 'XAF', CN: 'CNY', CO: 'COP', CR: 'CRC',
  CU: 'CUP', CV: 'CVE', CW: 'ANG', CY: 'EUR', CZ: 'CZK', DE: 'EUR',
  DJ: 'DJF', DK: 'DKK', DM: 'XCD', DO: 'DOP', DZ: 'DZD', EC: 'USD',
  EE: 'EUR', EG: 'EGP', ER: 'ERN', ES: 'EUR', ET: 'ETB', FI: 'EUR',
  FJ: 'FJD', FK: 'FKP', FM: 'USD', FO: 'DKK', FR: 'EUR', GA: 'XAF',
  GB: 'GBP', GD: 'XCD', GE: 'GEL', GF: 'EUR', GH: 'GHS', GI: 'GIP',
  ...
  LY: 'LYD', MA: 'MAD', MC: 'EUR', MD: 'MDL', ME: 'EUR', MF: 'EUR',
  MG: 'MGA', MH: 'USD', MK: 'MKD', ML: 'XOF', MM: 'MMK', MN: 'MNT',
  MO: 'MOP', MP: 'USD', MQ: 'EUR', MR: 'MRU', MS: 'XCD', MT: 'EUR',
  ...
  TF: 'EUR', TG: 'XOF', TH: 'THB', TJ: 'TJS', TL: 'USD', TM: 'TMT',
...
export function currencyForCountryCode(code: string | null | undefined): string | null {
  if (!code) return null;
